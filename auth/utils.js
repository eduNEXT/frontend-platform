...
import { getLoggingService } from './index'; // Lifted from here: https://regexr.com/3ok5o
...
var logFrontendAuthError = function logFrontendAuthError(error) {
...
var processAxiosError = function processAxiosError(axiosErrorObject) {
  ...
  if (!config) {
    error.customAttributes = _objectSpread({}, error.customAttributes, {
