...
var createJwtTokenProviderInterceptor = function createJwtTokenProviderInterceptor(options) {
  var tokenCookieName = options.tokenCookieName,
      tokenRefreshEndpoint = options.tokenRefreshEndpoint,
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(axiosRequestConfig) {
      var requestError;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.prev = 2;
              _context.next = 5;
              return getJwtToken(tokenCookieName, tokenRefreshEndpoint);
